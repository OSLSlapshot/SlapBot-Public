		...
		*/
		...
		var cats = {
			...
			stats: {
				title: "Stats",
				cmdAliases: ["stats"],
				cmdList: [ '!r / !stats  <name (optional)>', '!lb  <number (optional)>', '!lbc  <number (optional)>', '!lbt  <number (optional)>', '!lbs  <number (optional)>', '!pl', '!tl' ]
			},
			q: {
				title: "Queue",
				cmdAliases: ["queue", "q"],
			...
			match: {
				title: "Match",
				cmdAliases: ["match"],
				cmdList: [ '!active / !matches', '!d  <number>', '!mr  <win/w | loss/l>' ]
			},
			admin: {
				title: "Admin",
				cmdAliases: ["admin"],
				cmdList: [ '!kick  <name>', '!ar  <index>  <a | b>', '!rd / !cancel  <index>', '!ld', '!softreset', '!teamsreset', '!rl <l | b | st>' ]
			},
			fz: {
				title: "Funzone",
				cmdAliases: ["funzone"],
