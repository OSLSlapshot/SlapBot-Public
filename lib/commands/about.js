...
function about(msg) {
    ...
    if ((userMessage === '!about') || (userMessage === '!a') || (userMessage === '!support') || (userMessage === '!s') || (userMessage === '!donate') ) {
		...
		let embedFilesList = [];
		const embedThumb = new Discord.MessageAttachment('./thumbnails/about.png', 'about.png'); //from: me
		embedFilesList.push(embedThumb);
		
		const embedimg = new Discord.MessageAttachment('./thumbnails/kofi.png', 'kofi.png'); //from: https://more.ko-fi.com/brand-assets
