...
function role(msg) {
    ...
    if ((userMessage === '!subscribe') || (userMessage === '!sub')) {
		...
		let embedFilesList = [];
		const embedThumb = new Discord.MessageAttachment('./thumbnails/subscribe.png', 'subscribe.png'); //from: https://cdn.discordapp.com/emojis/587242207568986112.png?v=1
    ...
    if ((userMessage === '!unsubscribe') || (userMessage === '!unsub')) {
		...
		let embedFilesList = [];
		const embedThumb = new Discord.MessageAttachment('./thumbnails/unsubscribe.png', 'unsubscribe.png'); //from: https://cdn.discordapp.com/emojis/587242207568986112.png?v=1
		embedFilesList.push(embedThumb);
