...
import InviteLobby from './scripts/inviteLobby.js';
...
bot.on('ready', async () => {
	...
	if (cfg.inviteLobby.enable) {
		const inviteLobbyController = new InviteLobby();
		await inviteLobbyController.handleLobby();
	}
